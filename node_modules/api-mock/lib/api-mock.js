...
ApiMock = (function() {
  ...
  ApiMock.prototype.run = function() {
    ...
    return protagonist.parse(data, function(error, result) {
      ...
      try {
        return app.listen((
            (_ref = _this.configuration) != null ? (_ref1 = _ref.options) != null ? _ref1.port : void 0 : void 0) != null ? _this.configuration.options.port : 8080, process.env.OPENSHIFT_NODEJS_IP || "127.0.0.1");
      } catch (_error) {
        error = _error;
      }
    });
